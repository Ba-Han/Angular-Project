...
import { ecommerceRoutes } from 'app/modules/admin/setting/uploadredemptionexclusion/uploadredemption.routing';

@NgModule({
    declarations: [
        UploadRedemptionComponent,
        RedemptionUploadComponent
    ],
    imports: [
...
export class UploadRedemptionModule {
}
