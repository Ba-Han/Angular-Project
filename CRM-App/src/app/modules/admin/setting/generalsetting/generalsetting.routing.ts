...
import { SettingResolver, MemberGroupsResolver, UserGroupsResolver, MemberTierDefaultGroupsResolver } from 'app/modules/admin/setting/generalsetting/generalsetting.resolvers';
        ...
        children: [
            {
                ...
                resolve: {
                    ...
                    memberTiers: MemberTierDefaultGroupsResolver,
                }
