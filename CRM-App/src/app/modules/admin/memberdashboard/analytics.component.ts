...
export class AnalyticsComponent implements OnInit, OnDestroy {
    ...
    selectedMemberRegistrationDate: Date;
    selectedTransactionDate: Date;
    selectedActivePointDate: Date;
    selectedExpiredPointDate: Date;
    selectedEarnPointDate: Date;
     ...
     */
     ...
     registeredMemberByDate(type: string, filterDate: Moment, datepicker: MatDatepicker<Moment>){
        ...
        this.selectedMemberRegistrationDate = new Date();
        this.selectedMemberRegistrationDate.setMonth(this.filterRegister.month - 1);
        this.filterRegister.year = filterDate.year();
        this.selectedMemberRegistrationDate.setFullYear(this.filterRegister.year);
    ...
    transactionByDate(type: string, filterDate: Moment, datepicker: MatDatepicker<Moment>){
        ...
        this.selectedTransactionDate = new Date();
        this.selectedTransactionDate.setMonth(this.filterTrans.month - 1);
        this.filterTrans.year = filterDate.year();
        this.selectedTransactionDate.setFullYear(this.filterTrans.year);
    ...
    */
    ...
    totalActivePointByDate(type: string, filterDate: Moment, datepicker: MatDatepicker<Moment>) {
        ...
        this.selectedActivePointDate = new Date();
        this.selectedActivePointDate.setMonth(this.filterActivePoint.month - 1);
        this.filterActivePoint.year = filterDate.year();
        this.selectedActivePointDate.setFullYear(this.filterActivePoint.year);
    ...
    */
    ...
    totalExpiredPointByDate(type: string, filterDate: Moment, datepicker: MatDatepicker<Moment>) {
        ...
        this.selectedExpiredPointDate = new Date();
        this.selectedExpiredPointDate.setMonth(this.filterExpiredPoint.month - 1);
        this.filterExpiredPoint.year = filterDate.year();
        this.selectedExpiredPointDate.setFullYear(this.filterExpiredPoint.year);
     ...
     */
     ...
     totalEarnedPointByDate(type: string, filterDate: Moment, datepicker: MatDatepicker<Moment>) {
        ...
        this.selectedEarnPointDate = new Date();
        this.selectedEarnPointDate.setMonth(this.earnPoint.month - 1);
        this.earnPoint.year = filterDate.year();
        this.selectedEarnPointDate.setFullYear(this.earnPoint.year);
