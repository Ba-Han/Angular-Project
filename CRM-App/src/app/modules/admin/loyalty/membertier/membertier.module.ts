...
import { MemberTierDetailComponent } from 'app/modules/admin/loyalty/membertier/detail/detail.component';
import { ecommerceRoutes } from 'app/modules/admin/loyalty/membertier/membertier.routing';

@NgModule({
    declarations: [
        MemberTierComponent,
        MemberTierListComponent,
        MemberTierDetailComponent
    ],
    imports: [
