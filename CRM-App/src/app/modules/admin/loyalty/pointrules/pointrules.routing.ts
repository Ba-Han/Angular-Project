...
import { PointRulesResolver, PointRuleResolver, MemberTiersResolver, PointBasketResolver, StoresResolver } from 'app/modules/admin/loyalty/pointrules/pointrules.resolvers';
