...
export class LogService
{
    ...
    postWithTodayDate(responseStatusCode: number, logSearch: string = '', date: string = '', method: string, page: number = 0, limit: number = 10, sort: string = 'request_on', order: 'asc' | 'desc' | '' = 'asc', search: string = ''):
