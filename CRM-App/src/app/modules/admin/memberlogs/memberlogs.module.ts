...
import { memberLogsRoutes } from 'app/modules/admin/memberlogs/memberlogs.routing';
import { MemberLogsListComponent } from 'app/modules/admin/memberlogs/list/memberlogs.component';
import { MemberLogsDetailComponent } from 'app/modules/admin/memberlogs/detail/detail.component';

@NgModule({
    declarations: [
        MemberLogsComponent,
        MemberLogsListComponent,
        MemberLogsDetailComponent
    ],
    imports     : [
        RouterModule.forChild(memberLogsRoutes),
        MatButtonModule,
